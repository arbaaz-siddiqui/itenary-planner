        ...
        return {
            ...
            **({"note": note} if note else {}),
            "pricing_note": (
                ...
                f"NEVER write an approximate price: no '~', no 'around', no "
                f"'starting from about'. Every hotel carries `refundable_display` "
                f"with the exact figure — quote it verbatim. A guessed "
                f"'~Rs 1,17,000' overquoted a real Rs 90,508 by 25,000. "
